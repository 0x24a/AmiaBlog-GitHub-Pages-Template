...
rmtree("build/AmiaBlog/data/posts")
copytree("posts", "build/AmiaBlog/data/posts")
rmtree("build/AmiaBlog/data/attachments")
copytree("attachments", "build/AmiaBlog/data/attachments")
